    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="mb-6">
            <Link to="/student/dashboard" className="flex items-center gap-2 text-green-700 hover:text-green-800 mb-4 transition-colors">
              <ArrowLeft className="h-4 w-4" />
              <span className="text-sm font-medium">Back to Dashboard</span>
            </Link>
            <h1 className="text-2xl font-bold text-green-900 mb-2">PHQ-9 Assessment</h1>
            <div className="mb-4">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <h3 className="text-green-900 font-semibold mb-3">PHQ-9 Management Summary</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-green-200">
                      <th className="text-left py-2 text-green-900 font-medium">Score</th>
                      <th className="text-left py-2 text-green-900 font-medium">Depression severity</th>
                    </tr>
                  </thead>
              ...
              <div className="mt-4 space-y-2 text-green-800 text-sm">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm border border-green-200 p-6">
            <div className="space-y-6">
              {questions.map((question, index) => (
                <div key={index} className="border-b border-green-100 pb-6 last:border-b-0">
                  <h3 className="text-green-900 font-medium mb-4">
                    {index + 1}. {question}
                  </h3>
            ...
            <div className="mt-8 pt-6 border-t border-green-200">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-green-700 hover:text-green-800 hover:bg-green-100 rounded-lg transition-colors"
                >
